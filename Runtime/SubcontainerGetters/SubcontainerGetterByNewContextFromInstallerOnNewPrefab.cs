...
{
    public class SubcontainerGetterByNewContextFromInstallerOnNewPrefab : SubcontainerGetter
    {
        private readonly GameObject _prefab;
        private readonly IInstaller _installer;

        public SubcontainerGetterByNewContextFromInstallerOnNewPrefab(Container container, GameObject prefab, IInstaller installer) : base(container)
        {
            _prefab = prefab;
